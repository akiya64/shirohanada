...
<div class="entry-footer -sharelinks">
	...
	<a class="link" href="<?php echo $share_url['twitter']; ?>" title="share Twitter" target="_blank"><i class="icon icon-share-twitter"></i></a>
	<a class="link" href="<?php echo $share_url['facebook'] ?>" title="share Facebook" rel="nofollow" target="_blank"><i class="icon icon-share-facebook"></i></a>
	<a class="link" href="<?php echo $share_url['google_plus']; ?>" title="+1 GooglePlus" target="_blank"><i class="icon icon-share-google-plus"></i></a>
	<a class="link" href="<?php echo $share_url['pocket']; ?>" title="Get Pocket"><i class="icon icon-get-pocket"></i></a>
</div>
